...
class StackGenerator extends Generator {
  ...
  _addReactBoilerplate() {
    ...
    return Promise.all([
      ...
      'client/src/containers/Home/style.css',
      'client/src/containers/Home/Home.component.js',
      'client/src/containers/Home/Home.container.js',
      'client/src/containers/Page/index.js',
      'client/src/containers/Page/style.css',
      'client/src/containers/Page/Page.component.js',
      'client/src/containers/Page/Page.container.js',
